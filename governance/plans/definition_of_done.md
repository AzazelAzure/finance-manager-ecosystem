...
**Status:** living governance (HitM + agents). **Related:** [`plan_template.md`](./plan_template.md) §1a (V-tiers), [`glossary.md`](../reference/glossary.md) §12, [`branching_guidelines.md`](../execution/branching_guidelines.md), [`deployment_protocol.md`](../deployment/deployment_protocol.md).
...
- **Canonical matrix:** [`plans/S1/S1.B/distribution-channel-research/SEO_PRIORITY_MATRIX.md`](../../strategy/research/S1.B/distribution-channel-research/SEO_PRIORITY_MATRIX.md) (and linked `SEO_GUIDE_*` files in that folder).
