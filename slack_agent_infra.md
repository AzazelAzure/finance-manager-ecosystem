...
- `/home/pproctor/Documents/python/finance_manager/scripts/sprint_slack_pipeline_bridge.py`
  ...
  - Recommended default: reviewer-driven verdicts (`SPRINT_BRIDGE_AUTO_PASS_IF_NON_HITM=0`, `SPRINT_BRIDGE_AUTO_PASS_V0=0`) with reviewer agent mode enabled (`SPRINT_BRIDGE_REVIEW_AGENT_ENABLED=1` + `SPRINT_BRIDGE_REVIEW_WORKSPACE`).
