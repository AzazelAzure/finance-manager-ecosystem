...
- **`plans/`** — tactical execution plans under `plans/<Phase>/<Stage>/<sub-plan>/` (active S1.B: `plans/S1/S1.B/`); see [`plans/README.md`](plans/README.md). Strategic roadmap: `strategy/strategic-roadmap-reframe-53be/`. See `.cursor/skills/roadmap-rollout-planning/SKILL.md`.
