...
| P1 foundations | **BP1 PASS** | web #2 + ecosystem bump merged; VPS deployed | User sign-off 2026-04-29 (login, refresh, dashboard). |
| P2 public surface | **MERGED / VPS PULLED** | [web #3](https://github.com/AzazelAzure/finance-manager-web/pull/3) | Rebuild `web-blue`/`web-green` if not already; run **BP2** manual + Lighthouse, then mark PASS in `validation_gates.md`. |
