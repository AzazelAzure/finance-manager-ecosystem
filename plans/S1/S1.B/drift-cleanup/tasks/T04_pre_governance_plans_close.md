...
| --------------------------------------------------------- | -------------------------------------------------------- | ----------------------- |
| `PLAN_API_REFLEX_BETA_READINESS_2026-04-28`               | `plans/archived/cursor-layout-era/api-reflex-beta-readiness-plan-53be/`      | Add closure marker file |
| `PLAN_SERVER_BETA_INSTALL_BLUEGREEN_2026-04-28`           | `plans/archived/cursor-layout-era/server-beta-install-bluegreen-53be/`       | Add closure marker file |
| `PLAN_VPS_BETA_ROLLOUT_OPS_2026-04-28`                    | `plans/archived/cursor-layout-era/vps-beta-rollout-ops/`                     | Add closure marker file |
| `PLAN_SECURITY_HARDENING_MIDDLEWARE_ALIGNMENT_2026-04-28` | `plans/archived/cursor-layout-era/security-hardening-plan-53be/`             | Add closure marker file |
...
| `PLAN_VPS_REFLEX_BLUEGREEN_RECOVERY_2026-04-29`           | `plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/`       | Add closure marker file |
| `PLAN_FINANCE_MANAGER_WEB_BETA_ROLLOUT_2026-04-29`        | `plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be/`    | Add closure marker file |
...
for d in plans/archived/cursor-layout-era/api-reflex-beta-readiness-plan-53be \
         plans/archived/cursor-layout-era/server-beta-install-bluegreen-53be \
         plans/archived/cursor-layout-era/vps-beta-rollout-ops \
         plans/archived/cursor-layout-era/security-hardening-plan-53be \
         plans/archived/feat/dashboard-transactions-i18n-calendar-month \
         plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be \
         plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be; do
