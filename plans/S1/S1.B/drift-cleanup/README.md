...
plan_root: plans/S1/S1.B/drift-cleanup/
...
| `tasks/T04_pre_governance_plans_close.md` | `cursor/s1b/drift-cleanup/t04-pre-governance-plans-close` | `plans/archived/cursor-layout-era/api-reflex-beta-readiness-plan-53be/`, etc.                                                                                   | n/a      | Formal registry close-out  |
