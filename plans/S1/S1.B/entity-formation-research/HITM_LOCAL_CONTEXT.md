...
4. **Stripe / PayMongo / Xendit** KYB for **PH spouse-led MoR** (primary) vs contingency columns — **seated jointly** with [`../payment-provider-research/README.md`](../payment-provider-research/README.md) §0.6. **HitM pipeline lock (2026-05-03):** [`README.md`](./README.md) §0.2; strategic mirror [`01_unit_economics_and_costs.md`](../../../../strategy/strategic-roadmap-reframe-53be/01_unit_economics_and_costs.md) §5.0. **L1** (BI timeline) remains time-gated independently of PSP choice.