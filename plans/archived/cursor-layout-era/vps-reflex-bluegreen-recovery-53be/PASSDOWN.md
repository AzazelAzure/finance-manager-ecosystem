...
**Plan root:** `plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/`  
...
- Plan docs under `plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/` should be committed on an appropriate feature branch when ready.
