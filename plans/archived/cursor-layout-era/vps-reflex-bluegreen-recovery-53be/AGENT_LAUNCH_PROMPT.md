...
1. plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/README.md
2. plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/validation_gates.md
3. plans/archived/cursor-layout-era/vps-reflex-bluegreen-recovery-53be/CROSS_AGENT_COORDINATION.md
...
7. plans/archived/cursor-layout-era/server-beta-install-bluegreen-53be/known_good_beta_state_apr28.md (baseline context; Namecheap VPS is dev@159.198.75.194)
