...
sibling_plan: plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be
deployment:
  required: true
  target_services:
    - reflex
...
| **B — Reflex stable** | **Pass (caveat)** | **2026-04-30:** Dashboard + websocket OK; chart blocks still empty — tracked as **data population** follow-up, not blocking BG. |
