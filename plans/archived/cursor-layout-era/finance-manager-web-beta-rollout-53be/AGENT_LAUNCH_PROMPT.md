...
You are the JS frontend agent for plan:
  plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be/
...
1. plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be/README.md
2. plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be/validation_gates.md
3. plans/archived/cursor-layout-era/finance-manager-web-beta-rollout-53be/CROSS_AGENT_COORDINATION.md
