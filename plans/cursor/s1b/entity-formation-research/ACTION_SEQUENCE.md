...
> Distilled from all files in `plans/cursor/s1b/entity-formation-research/`.
...
- **Reference:** [HITM_LOCAL_CONTEXT.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/HITM_LOCAL_CONTEXT.md) §1
...
- **Deliverable:** Fill [US_LLC_REGISTRATION_AND_TAX_PATHWAYS.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/US_LLC_REGISTRATION_AND_TAX_PATHWAYS.md) row **P1**
...
- **Action:** Review and finalize [PH_COUNSEL_QUESTIONNAIRE.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/PH_COUNSEL_QUESTIONNAIRE.md) — all 4 sections covering Anti-Dummy roles, DTI vs OPC, intercompany agreements, BMBE classification
...
- **Owner:** HitM (questionnaire already exists)
- **Action:** Review and finalize [TAX_ADVISOR_QUESTIONNAIRE.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/TAX_ADVISOR_QUESTIONNAIRE.md) — LLC classification vs FEIE, PE risk, transfer pricing, Form 5471/8858 exposure
...
- **Deliverable:** Lock **L1** in [DECISION_MATRIX.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/DECISION_MATRIX.md) Matrix 2 — set status to `LOCKED`, record branch + date + evidence
...
- **Action:** Counsel reviews [DTI_VS_OPC_COMPARISON.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/DTI_VS_OPC_COMPARISON.md) and answers questionnaire. Key decision: Does the liability shield of OPC justify the higher compliance burden at pre-revenue/early-revenue scale?
- **Deliverable:** Update [DECISION_MATRIX.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/DECISION_MATRIX.md) Matrix 3 — PH row locked to DTI or OPC
...
- **Deliverable:** Update [SPOUSE_INVOLVEMENT_REQUIREMENTS.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/SPOUSE_INVOLVEMENT_REQUIREMENTS.md) with counsel's written boundaries
...
- **Deliverable:** Update [PH_TAX_BMBE_AND_DEDUCTIONS.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/PH_TAX_BMBE_AND_DEDUCTIONS.md) §5 checklist item 5
...
- **Cross-reference:** [../payment-provider-research/README.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/payment-provider-research/README.md)
...
- **Actions (all required for S1.B exit):**
  ...
  - Lock all remaining rows in [DECISION_MATRIX.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/DECISION_MATRIX.md) (L1, L5)
  - Update [RESEARCH_ARTIFACTS.md](file:///home/pproctor/Documents/python/finance_manager/plans/cursor/s1b/entity-formation-research/RESEARCH_ARTIFACTS.md) with draft→completed status per artifact
