...
The **Advanced PWA** implementation sprint (`plans/cursor/s1b/pwa-implementation-branch/`) is active on **`finance_manager_web`** (dashboard quick paths, offline/outbox, mutating API contract).
