...
- Parent workspace: plan files only (already under `plans/cursor/s1b/pwa-implementation-branch/`)
...
- Plan tree present: `ls plans/cursor/s1b/pwa-implementation-branch/tasks/T*.md` → T00–T16.
