...
| `entity-formation-research/`         | `draft`     | unassigned (HitM-led decisions)       | none                                                             | **Hub:** [`entity-formation-research/README.md`](./entity-formation-research/README.md); **artifacts:** [`RESEARCH_ARTIFACTS.md`](./entity-formation-research/RESEARCH_ARTIFACTS.md). PH-first paths, BI timeline branches, US-bridge feasibility, spouse-led fallback, registration breakpoints. Gates payment research. |
