...
**S1.B linkage:** Summarized in parent plan [`README.md`](./README.md) **§1.7**; stage sprint index [`plans/cursor/s1b/README.md`](../README.md#pwa-sprint-activation-index); strategic exit language in [`validation_gates.md`](../../strategic-roadmap-reframe-53be/validation_gates.md) (S1.B PWA bullet) and [`S1_public_beta_position.md`](../../strategic-roadmap-reframe-53be/phases/S1_public_beta_position.md) (W2 / exit criteria).  
