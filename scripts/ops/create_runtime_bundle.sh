...
Bundle content (lean runtime only):
  ...
  - scripts/local-stack/fm_docker.sh
  - scripts/ops/fm_server_beta.sh
  - scripts/ops/
  - finance_manager_api/
  - finance_manager_web/
...
copy_path "scripts/local-stack/fm_docker.sh" "scripts/local-stack/fm_docker.sh"
copy_path "scripts/ops/fm_server_beta.sh" "scripts/ops/fm_server_beta.sh"
copy_path "scripts/ops/" "scripts/ops/"
