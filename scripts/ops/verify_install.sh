...
check_dir "${REPO_ROOT}/scripts/ops"
check_file "${REPO_ROOT}/scripts/ops/create_runtime_bundle.sh"
check_file "${REPO_ROOT}/scripts/ops/push_runtime_bundle.sh"
check_file "${REPO_ROOT}/scripts/ops/verify_release_manifest.sh"
